      ...
      <div className="container">
        <div className="row">
          <div className="footer-widget col-lg-3 col-12 mb-lg-0 mb-4 pr-lg-4">
            ...
            <ul>
              <li><i className="fa fa-phone" /><span>+91 8537086332</span></li>
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6 text-center text-md-left">
            <p className="footer-copyright">© 2024 Mazaar Shop, Template by <a href="http://nileforest.com/" target="_blank">Nileforest</a></p>
          </div>
